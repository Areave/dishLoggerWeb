...
const ItemsPageTemplate: React.FC<any> = ({
    ...
    return <div className="page items-page">
        <div className="items-page__content">
            <ItemModalTemplate itemType={itemType} editedItem={editedItem} setEditedItem={setEditedItem} addItem={addItem} updateExistingItem={updateExistingItem} showModal={showModal}
                          closeModal={() => {
                              setEditedItem(null);
                              setShowModal(false)}}/>
